...
RefData.FIRST_NAMES = [
    "Growth", "Conservative", "Balanced", "Aggressive", "Income", "Diversified", "Hedge",
    "Asset", "Bonds", "Mutual funds", "Income fund", "Retirement"
];

RefData.LAST_NAMES = [
    "Portfolio", "Income", "Focused", "Strategy"
];
...
RefData.IT_SKILLS = ['adv1', 'adv2', 'adv3', 'adv4', 'adv5'];

RefData.IT_SKILLS_NAMES = ['adv1', 'adv2', 'adv3', 'adv4', 'adv5'];
